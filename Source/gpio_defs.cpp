...
void INP_GPIO_GAME()
{
	unsigned nSelReg = ARM_GPIO_GPFSEL0 + ( GAME_OUT / 10 ) * 4;
	unsigned nShift = ( GAME_OUT % 10 ) * 3;
...
void OUT_GPIO_GAME()
{
	const unsigned nSelReg = ARM_GPIO_GPFSEL0 + ( GAME_OUT / 10 ) * 4;
	const unsigned nShift = ( GAME_OUT % 10 ) * 3;
