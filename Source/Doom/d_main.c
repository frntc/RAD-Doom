...
static void InitGameVersion(void)
{
    ...
    p = 0;//M_CheckParmWithArgs("-gameversion", 1);
...
void D_DoomMain (void)
{
    ...
    respawnparm = 0;//M_CheckParm ("-respawn");
...
lumphash = NULL;
    ...
    // Load PWAD files.
    modifiedgame = 0;// W_ParseCommandLine();
...
//    W_PrintDirectory();
    ...
    p = 0;//M_CheckParmWithArgs ("-playdemo", 1);
    ...
    if (!p)
    {
        ...
        // of the screen.
        //
	p = 0;//M_CheckParmWithArgs("-timedemo", 1);
    ...
    p = 0;//M_CheckParmWithArgs("-skill", 1);
    ...
    p = 0;//M_CheckParmWithArgs("-episode", 1);
    ...
    p = 0;//M_CheckParmWithArgs("-timer", 1);
    ...
    p = 0;//M_CheckParmWithArgs("-warp", 1);
    ...
    p = 0;//M_CheckParmWithArgs("-loadgame", 1);
